...
export default function TrackingLandingPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-[#f9fafb] lg:flex-row lg:items-stretch">
      ...
      <div className="hidden lg:flex lg:h-screen lg:w-1/2 lg:items-center lg:p-8">
        <div className="relative h-full flex-1 overflow-hidden rounded-[24px] border border-[#e5e7eb]">
          <TrackingMap
      ...
      <div className="flex w-full flex-col items-center justify-center gap-10 px-5 pb-10 pt-8 lg:h-screen lg:w-1/2 lg:gap-20 lg:py-8 lg:pr-8">
        ...
        <div className="flex w-full max-w-[480px] flex-col gap-8 lg:gap-11">
          <header className="flex flex-col items-center gap-3 text-center lg:gap-4">
            <h1 className="text-2xl font-bold leading-tight text-[#475467] lg:text-3xl">
              Track Your Order
            </h1>
            <p className="text-sm leading-snug text-[#344054] lg:text-base">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center gap-4">
              <p className="w-full text-center text-sm font-medium text-[#344054] lg:text-base">
                Or
              </p>
              <FeatureCards />
            </div>
          ...
          <footer className="flex flex-col items-center gap-1 text-center text-xs text-[#344054] lg:text-base">
